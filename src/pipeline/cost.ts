 ...
 *
 * @param calls      LLM calls recorded during the run.
 * @param durationMs Optional run wall-clock duration in milliseconds; when
 *                   provided it is rendered via formatDuration and appended to
 *                   the headline.
 */
